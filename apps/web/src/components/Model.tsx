      ...
      <div className="bg-white p-4 rounded-lg shadow-lg max-w-md w-full">
        ...
        <div className="flex justify-end mt-4">
          ...
          {!session ? (
            ...
            <Button onClick={() => onAdd(product)} className="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-400">Aggiungi al carrello</Button>
          )}
        </div>
      </div>
    </div>
