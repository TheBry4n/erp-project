...
export function ModalProd({ isOpen, onConfirm, onReqClose, quantity, setQuantity }: ModalProdProps){
                    ...
                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div className="sm:flex sm:items-start">
                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                <h3 className="text-lg leading-6 font-medium text-gray-900">Inserisci la quantità</h3>
                                <div className="mt-2">
                                    <input
                                        type="number"
                                        className="w-20 border border-gray-300 rounded-md p-1 text-black"
                                        value={quantity}
                                        min="1"
